...
const AddIncome = ({ token, onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-neutral-900 rounded-2xl p-6 w-96 relative">
        ...
        <h2 className="text-xl font-semibold mb-4 text-white">Add Income</h2>
        <form onSubmit={handleAddIncome} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-green-600 hover:bg-green-700 text-white py-2 rounded-xl font-semibold shadow-md"
          >
